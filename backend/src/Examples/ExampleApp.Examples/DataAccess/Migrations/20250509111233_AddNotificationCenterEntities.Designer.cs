...
namespace ExampleApp.Examples.DataAccess.Migrations
{
    ...
    [Migration("20250509111233_AddNotificationCenterEntities")]
    partial class AddNotificationCenterEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeanCode.NotificationCenter.DataAccess.DbMessage<System.Guid>", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(34)
                    ...
                    b.HasIndex("UserId", "DateCreated", "Id");

                    b.ToTable("Messages");
                });

            modelBuilder.Entity("LeanCode.NotificationCenter.DataAccess.UserData<System.Guid>", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTimeOffset>("LastReadTime")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("UserId");

                    b.ToTable("UserData<Guid>");
                });
