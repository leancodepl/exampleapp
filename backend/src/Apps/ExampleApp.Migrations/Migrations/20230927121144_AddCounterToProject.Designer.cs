...
namespace ExampleApp.Migrations.Migrations
{
    ...
    [Migration("20230927121144_AddCounterToProject")]
    partial class AddCounterToProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExampleApp.Core.Domain.Projects.IncludedEntity", b =>
                {
                    b.HasOne("ExampleApp.Core.Domain.Projects.Project", "Project")
            ...
            modelBuilder.Entity("ExampleApp.Core.Domain.Projects.Project", b =>
                {
                    ...
                    b.OwnsMany("ExampleApp.Core.Domain.Projects.OwnedEntity", "OwnedEntities", b1 =>
                        {
                            ...
                            b1.Property<int>("SomeInt")
                                .HasColumnType("integer");

                            b1.Property<string>("SomeString")
                                .IsRequired()
                                .HasMaxLength(100)
                                .HasColumnType("character varying(100)");
